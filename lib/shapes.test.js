//import required shapes.js file
const { Triangle, Square, Circle } = require("./shapes");

//tests rendering of triangle svg string to ensure output is as expected
...
//tests rendering of square svg string to ensure output is as expected
...
//tests rendering of circle svg string to ensure output is as expected
