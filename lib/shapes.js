...
class Triangle extends Shape {
    ...
    render() {
        return `<polygon points="150, 0 300,200 0,200" fill="${this.shapeColour}" /><text x="100" y="100" font-size="40" text-anchor="middle" fill="${this.textColour}">${this.text}</text></svg>`;
    }
